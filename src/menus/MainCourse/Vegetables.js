...
export default () => {
    ...
    <div className="column">
        ...
        <ul>
            ...
            <li>	<div className="menu-body">	<p className="dish">	{placeholder}			142	<span>	青菜豆腐	</span>	<span>	VEGETABLE AND BEAN CURD	</span>	</p>	<p className="has-text-right price">	8.75	</p>	</div>	</li>
            ...
            <li>	<div className="menu-body">	<p className="dish">	{placeholder}			145	<span>	兰花豆腐	</span>	<span>	BROCCOLI WITH BEAN CURD	</span>	</p>	<p className="has-text-right price">	8.75	</p>	</div>	</li>
