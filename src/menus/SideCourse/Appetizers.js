...
export default () => {
    ...
    <div className="column">
        ...
        <ul>
            ...
            <li>	<div className="menu-body">	<p className="dish"> {placeholder}				01	<span>	广东春捲	</span>	<span>	EGG ROLL (1)	</span>	</p>	<p className="has-text-right price">	1.45	</p>	</div>	</li>
            ...
            <li>	<div className="menu-body">	<p className="dish">	<span style={{ color: "red" }}>	*	</span>	12	<span>	椒麻虾	</span>	<span>	TANGY SPICY SHRIMP	</span>	</p>	<p className="has-text-right price">	7.25	</p>	</div>	</li>
            <li>	<div className="menu-body">	<p className="dish">	{placeholder}			13	<span>	宝宝盘	</span>	<span>	PU-PU PLATTER	</span>	</p>	<p className="has-text-right price">	10.95	</p>	</div>	</li>
            <li>	<div className="menu-body">	<p className="dish">	{placeholder}			14	<span>	牛肉串	</span>	<span>	BEEF STICKS (4)	</span>	</p>	<p className="has-text-right price">	6.25	</p>	</div>	</li>
