    ...
    <div className="columns">
        ...
        <div className="column is-two-thirds menu">
            ...
            <ul>
                ...
                <li>	<div className="menu-body">	<p className="dish">					<span>	SHRIMP AND MIXED VEGETABLES	</span>	</p>	<p className="has-text-right price">	10.25	</p>	</div>	</li>
                <li>	<div className="menu-body">	<p className="dish">					<span>	BEAN CURD AND MIXED VEGETABLES	</span>	</p>	<p className="has-text-right price">	8.75	</p>	</div>	</li>
                <li>	<div className="menu-body">	<p className="dish">					<span>	CHICKEN AND SHRIMP AND VEGETABLES	</span>	</p>	<p className="has-text-right price">	10.25	</p>	</div>	</li>
